		...
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<h4 class = "navbar-text navbar-right">QUẢN LÝ TÀI KHOẢN NGƯỜI DÙNG</h4>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<div class = "alert alert-info">Tài khoản người dùng</div>
					<button id = "add_admin" type = "button" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Thêm</button>
					<button id = "show_admin" type = "button" style = "display:none;" class = "btn btn-success"><span class = "glyphicon glyphicon-circle-arrow-left"></span> Quay lại</button>
					<br />
					<br />
					<div id = "admin_table">
					...
					<div id = "admin_form" style = "display:none;">
						...
						<div class = "col-lg-6">
							<form method = "POST" action = "save_admin_query.php" enctype = "multipart/form-data">
								...
								<div class = "form-group">	
									<button class = "btn btn-primary" name = "save_admin"><span class = "glyphicon glyphicon-save"></span> Lưu</button>
								</div>
							</form>		
						</div>	
					</div>
